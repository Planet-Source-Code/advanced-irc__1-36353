...
Sub SysSaveIRCInfo(ByVal iList As Variant)
    With frmMain.INIAccess
        ...
        .INISaveSetting "Navn", iList(3)
        .INISaveSetting "BrukIdent", iList(4)
        .INISaveSetting "AktivServer", iList(5)
        .INISaveSetting "AktivPort", iList(6)
        .INISaveSetting "AutoMode", iList(7)
    End With
End Sub
...
Function SysGetIRCInfo() As Variant
    ...
    With frmMain.INIAccess
        ...
        V(3) = .INIGetSetting("Navn")
        V(4) = .INIGetSetting("BrukIdent")
        V(5) = .INIGetSetting("AktivServer")
        V(6) = .INIGetSetting("AktivPort")
        V(7) = .INIGetSetting("AutoMode")
    End With
    SysGetIRCInfo = V
End Function
...
Sub SysSaveDCCInfo(dList As Variant)
    With frmMain.INIAccess
        ...
        .INISaveSetting "UseAUDPDCCFT", dList(9)
        .INISaveSetting "UseDCCPorts", dList(10)
        .INISaveSetting "DCCPortRange", dList(11)
    End With
End Sub
...
Function SysGetDCCInfo() As Variant
    ...
    With frmMain.INIAccess
        ...
        V(9) = .INIGetSetting("UseAUDPDCCFT")
        V(10) = .INIGetSetting("UseDCCPorts")
        V(11) = .INIGetSetting("DCCPortRange")
    End With
    SysGetDCCInfo = V
End Function
...
Sub GetDCCInfo()
    ...
    With DCCInfo
        ...
        .UDP = ToVal(dList(9))
        .UDCCPorts = ToVal(dList(10))
        .DCCPortRange = dList(11)
    End With
End Sub
...
Sub LoadAutoJoin()
    ...
    Srv = StatusWnd(ActiveServer).IRC.RemoteHost
