        ...
        If S = vbLf Or S = vbCr Then
            ...
            If Not SCmd = "" Then
                If Left(SCmd, 7) = "ACTION" Then
                    Output "* " & Me.Tag & " " & TrimCTCP(Mid(SCmd, 8)), Me, ColorInfo.cAction
                Else
...
Private Sub Chat_Error(ByVal Number As Integer, Description As String, ByVal Scode As Long, ByVal Source As String, ByVal HelpFile As String, ByVal HelpContext As Long, CancelDisplay As Boolean)
    Chat.Close
    Output "*** Chat closed (Error " & Number & ": " & Description & ")", Me, vbRed
End Sub
...
Private Sub Form_Activate()
    ...
    With frmMain.IRCStatus
        .ChangeServer StatusWnd(ActiveServer).IRC.RemoteHost
    ...
    If ((Shift = vbCtrlMask And 7) And ((KeyCode = vbKeyV) Or (KeyCode = Asc("v")))) Then
        ...
        If UBound(V) > LBound(V) Then 'Multiline
            ...
            For C = LBound(V) To UBound(V)
                ...
                Output "<" & IRCInfo.Nick & "> " & V(C), Me, ColorInfo.cOwn
            Next
        End If
        KeyCode = 0
        Shift = 0
    ...
    ElseIf KeyAscii = 13 Then
        ...
        If (Chat.State = 0) And (txtInput = "") Then
            If DCCProtocol = dccPassive Then
                ...
                Output "*** Setting up listening socket...", Me, ColorInfo.cStatus
            ElseIf DCCProtocol = dccNormal Then
                Chat.Close
                Chat.Connect
                Output "*** Attempting to connect...", Me, ColorInfo.cStatus
            End If
            KeyAscii = 0
            Exit Sub
        ...
        If Left(txtInput, 4) = "/me " Then
            ...
            Output "* " & IRCInfo.Nick & " " & txtInput, Me, ColorInfo.cAction
        ...
        Else
            ...
            Output "<" & IRCInfo.Nick & "> " & txtInput, Me, ColorInfo.cOwn
        End If
        txtInput = ""
        KeyAscii = 0
