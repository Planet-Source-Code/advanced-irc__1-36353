    ...
    With frmMain.airc_Sc(script_used)
        ...
        Else
            With listScripts.SelectedItem
                AddScript V, .Text, CStr(ScName), CStr(ScFunc), frmMain.airc_Sc(script_used)
                .Text = ScName
...
Sub AddScript(V As classScript, File_Name As String, Sc_Name As String, Sc_Func As String, ScrCtl As ScriptControl)
    Inc ScriptArrayU
