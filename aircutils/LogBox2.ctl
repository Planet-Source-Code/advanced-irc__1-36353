...
'Dim Cache As IPictureDisp 'Contents cache, display speedup?
...
Public Sub AddLine(ByVal S As String, Optional ByVal Fore_Color As Long = -1, Optional ByVal Back_Color As Long = -1)
Dim V() As String
LU = LU + 1
ALU = ALU + 1
