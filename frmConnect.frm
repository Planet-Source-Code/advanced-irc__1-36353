...
Begin VB.Form frmConnect 
   ...
   Begin VB.PictureBox frames 
      ...
      Begin VB.CheckBox chkUDP 
         Caption         =   "If available, use UDP instead of TCP/IP"
         Enabled         =   0   'False
         Height          =   255
         Left            =   120
         TabIndex        =   104
      ...
      Begin VB.CheckBox chkBeskyttVirus 
         Caption         =   "Protect against SHS, VBS and BAT viruses"
         Height          =   255
         Left            =   120
         TabIndex        =   11
         ToolTipText     =   "Ignores any files with these extensions"
         Top             =   600
         Width           =   3975
      End
   ...
   Begin VB.PictureBox frames 
      ...
      Begin VB.CheckBox chkmIRCColors 
         Caption         =   "Interpret color codes as mIRC colors instead of RFC"
         Height          =   255
         Left            =   120
         TabIndex        =   37
         Top             =   3360
...
Private Sub chkUDP_Click()
    TestValue Not -chkUDP, chkPumpDCC
End Sub
...
Sub ChkConVal()
    ...
    ElseIf StatusWnd(ActiveServer).IRC.State = 0 Then
...
Private Sub Form_Load()
    ...
    If Not StatusWnd(ActiveServer).IRC.State = 0 Then cmdConnect.Enabled = False Else cmdConnect.Enabled = True
    ChkConVal
    ...
    With treeOption
        ...
        '.Nodes.Add "Root2", tvwChild, "2Messages", "Messages"
